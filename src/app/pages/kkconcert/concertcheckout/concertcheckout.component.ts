...
@Component({
  selector: 'app-concertcheckout',
  templateUrl: './concertcheckout.component.html',
  styleUrls: ['./concertcheckout.component.scss']
})
export class ConcertcheckoutComponent implements OnInit, AfterViewInit {
  cartCheck: any;
  subtotal: number = 0;
  tax: number = 0;
  ...
  updateMemberDetailsFun(payment){
